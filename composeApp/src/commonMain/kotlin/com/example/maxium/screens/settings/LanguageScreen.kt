package com.example.maxium.screens.settings
...
import com.example.maxium.components.BackTopBar
import com.example.maxium.components.RadioButton
import com.example.maxium.getLanguage
import com.example.maxium.languagesMap
import com.example.maxium.models.LanguageDisplay
                ...
                items(languagesMap.keys.toList()) { key ->
                    ...
                    val languagesDisplay = mapOf(
                        Languages.EN to LanguageDisplay(
                            Res.string.en_language,
                            Res.string.en_en_language
                        ),
                        Languages.RU to LanguageDisplay(
                            Res.string.ru_language,
                            Res.string.en_ru_language
                        )
                    )
